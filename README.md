...
The goal of this section is to get a visitor counter, or more accurately a hit counter on my portfolio website using DynamoDB. 

Another key achievement of this chunk is to enable bucket versioning, and lifecycle policies for the S3 bucket. Also, the hit counter was refactored to become better visitor counter, that notes total visits, and unique visits. 
